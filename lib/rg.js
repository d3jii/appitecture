...
exports.generate_routes = function( parsed_data,config,controller_dictionary ){
	...
	for(var dir in controller_dictionary){ 
		var route_js_string = "module.exports = function(app){\n\r" + controller_dictionary[dir].route_strings.join('') + "\n\r}";
		directory_module.createFile(routes_dir_base,routes_dir_base+"/"+dir+".js",route_js_string);
	} 
}